            ...
            <div class="topbar_right">
                ...
                <form method="GET" action="" class="topbar_search" id="frm_search">
                    ...
                    <div class="topbar_search-input-wrapper">
                        <span class="topbar_search-icon">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
                        </span>
                        <input type="text" name="search" class="form-control" placeholder="Search..." value="<?php echo security_helper::xss_clean($search_query); ?>" oninput="this.form.submit()">
                    </div>
                    <?php if (!empty($search_query)): ?>
                        <a href="?tab=<?php echo security_helper::xss_clean($active_tab); ?>" class="btn btn--ghost btn--sm">Clear</a>
                    <?php endif; ?>
                </form>
                <!-- NOTIFICATION BELL -->
